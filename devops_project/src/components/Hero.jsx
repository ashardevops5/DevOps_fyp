...
const Hero = forwardRef((props, ref) => (
  <section
    ref={ref}
    id="hero"
    className={`min-h-screen flex flex-col justify-center items-center snap-start relative text-center p-10
  ...
  >
    ...
    <div className="relative z-10 flex flex-col justify-center items-center text-center opacity-0 animate-fadeIn">
      ...
      <p className="text-lg sm:text-2xl max-w-3xl mb-8 text-gray-800 dark:text-gray-200">
        Learn, deploy, and scale with modern DevOps tools and best practices. Master cloud, CI/CD
        pipelines, containerization, and more.
      </p>
