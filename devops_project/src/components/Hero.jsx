...
const Hero = forwardRef((props, ref) => {
  const heroRef = ref || useRef(null);
  const [navHeight, setNavHeight] = useState(80); // default navbar height
  ...
  return (
    <section
      ref={heroRef}
      id="hero"
      className="min-h-screen flex flex-col justify-center items-center snap-start relative text-center px-6 pb-10"
      style={{ paddingTop: `${navHeight + 8}px` }} // ✅ Navbar offset
    >
      <div className="absolute inset-0 bg-black/0 dark:bg-black/60"></div>

      <div className="relative z-10 flex flex-col justify-center items-center text-center opacity-0 animate-fadeIn">
